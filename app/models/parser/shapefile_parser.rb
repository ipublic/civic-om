require 'rdf'
module Parser
  class ShapefileParser < Parser::Base
        ...
        Dir.mktmpdir do |temp_dir|
          ...
          File.open(@geojson_file_name) do |jsf|
            ...
            geojson['features'].first['properties'].each do |k,v|
              ...
              @columns << LinkedData::Property.new(:term => k, :label => k.upcase, :expected_type => range.to_s)
            end
            @columns << LinkedData::Property.new(:term =>'geometry', :label => "Geometry", :expected_type => RDF::OM_CORE.GeoJson.to_s)
      ...
      Dir.mktmpdir do |temp_dir|
        ...
        File.open(@geojson_file_name) do |jsf|
          ...
          geojson['features'].each do |feature|
            ...
            @columns.each {|sp| raw_record[sp.term] = feature['properties'][sp.term]}
